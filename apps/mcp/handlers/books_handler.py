...
from lib.sheet_utils import tokenize, parse_monthly_goal
...
class BooksHandler(BaseHandler):
    ...
    def _build_doc_freq(self) -> tuple[dict[str, int], list[dict[str, Any]]]:
    ...
    def _detect_subject(self, tokens: list[str]) -> str | None:
    ...
    def _apply_gap_cutoff(self, candidates: list[dict], limit: int) -> list[dict]:
    ...
    def _calculate_confidence(self, sliced: list[dict]) -> float:
